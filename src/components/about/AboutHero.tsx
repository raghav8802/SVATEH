  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-28 lg:px-8 lg:py-32">
        <h1 className="mb-4 text-center font-serif text-4xl font-medium text-svateh-espresso lg:text-6xl">
          Pamper Yourself. The World Can Wait.
        </h1>
        <p className="mx-auto max-w-2xl text-center font-sans text-base text-svateh-espresso/80 lg:text-lg">
