...
export function BrandBadges() {
  return (
    <section className="border-y border-[#E9DDCF]/50 bg-svate-beige/30 py-8">
      <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-center gap-8 px-4 sm:gap-10 sm:px-6 lg:justify-between lg:gap-6 lg:px-8">
        {badges.map(({ label, icon: Icon }) => (
          <div
            key={label}
            className="flex items-center gap-2.5 text-svate-espresso"
          >
            <Icon className="h-5 w-5 shrink-0 text-svate-gold" strokeWidth={1.5} />
